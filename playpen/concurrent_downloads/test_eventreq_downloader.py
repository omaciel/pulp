...
from pulp.common.download.downloaders.eventreq import HTTPEventletRequestsDownloader
...
def _downloader_config():
    null_kwargs = {}
    ssl_kwargs = {'ssl_validation': True}
    proxy_kwargs = {'ssl_validation': True,
                    'proxy_host': 'https://204.84.216.200',
                    'proxy_port': 3128,}
    kwargs = proxy_kwargs
